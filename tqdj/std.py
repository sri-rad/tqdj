...
class TqdmDefaultWriteLock(object):
    ...
    def __init__(self):
        ...
        self.create_th_lock()
        cls = type(self)
        self.locks = [lk for lk in [
            cls.mp_lock, cls.th_lock] if lk is not None]
...
class tqdj(Comparable):
    ...
    def format_meter(n, total, elapsed, ncols=None, prefix='', ascii=False,
                     ...
                     postfix=None, unit_divisor=1000, initial=0, player=None,
                     **extra_kwargs):
        """
        ...
        elapsed_str = tqdj.format_interval(elapsed)
        ...
        format_sizeof = tqdj.format_sizeof
        ...
        remaining_str = tqdj.format_interval(remaining) if rate else '?'
        ...
        if prefix:
            ...
            l_bar = prefix if bool_prefix_colon_already else prefix + \
                ' // ♪♪ {} ♪♪ ~ '.format(player.playing_now)
        else:
            l_bar = '♪♪ {} ♪♪ ~ '.format(player.playing_now)
    ...
    def __repr__(self):
        return self.format_meter(**self.format_dict, player=self.player)
...
def trange(*args, **kwargs):
    ...
    """
    return tqdj(_range(*args), **kwargs)
